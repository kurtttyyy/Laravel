...
Route::controller(GuestPageController::class)->group(function () {
    ...
    Route::get('/application/non_teaching/procedure', 'display_steps')->name('guest.applicationNonTeachingSteps');
    Route::get('/application/teaching/procedure', 'display_steps')->name('guest.applicationTeachingSteps');
